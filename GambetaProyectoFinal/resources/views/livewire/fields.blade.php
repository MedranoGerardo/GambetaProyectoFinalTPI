        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <!-- Nombre -->
                    <div class="mb-3">
                        <label class="form-label" style="color: #000 !important;">Nombre</label>
                    ...
                    <!-- Tipo -->
                    <div class="mb-3">
                        <label class="form-label" style="color: #000 !important;">Tipo</label>
                    ...
                    <!-- Precio -->
                    <div class="mb-3">
                        <label class="form-label" style="color: #000 !important;">Precio por hora</label>
                    ...
                    <!-- Imagen -->
                    <div class="mb-3">
                        <label class="form-label" style="color: #000 !important;">Imagen (opcional)</label>
                    ...
                    <!-- Estado -->
                    <div class="mb-3">
                        <label class="form-label" style="color: #000 !important;">Disponibilidad</label>
